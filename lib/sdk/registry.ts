...
import {
  ...
  AdverseEventStatsResponseSchema,
  AdverseEventStatsSchema,
  DrugLiteratureResponseSchema,
  DrugShortagesResponseSchema,
  DrugSummarySchema,
  DrugPgxResponseSchema,
  DrugTrialsResponseSchema,
  DrugHistoryResponseSchema,
  PgxPairSchema,
  TrialEntrySchema,
  LiteratureReferenceSchema,
  MeshTreeNodeSchema,
  ReactionDrugRowSchema,
  ReactionMetaSchema,
  ReactionSchema,
  ...
  ConditionDrugRowSchema,
  RelatedConditionSchema,
  ConditionResponseSchema,
  ConditionsListResponseSchema,
  ShortageEntrySchema,
  ShortageStatusSchema,
...
> = [
  ...
  ["ControlledSubstance", ControlledSubstanceSchema],
  ["OrangeBook", OrangeBookSchema],
  ...
  ["Drug", DrugSchema],
  ["DrugsBatchRequest", DrugsBatchRequestSchema],
  ["DrugsBatchResponse", DrugsBatchResponseSchema],
  ...
  ["ShortageStatus", ShortageStatusSchema],
  ["ShortageEntry", ShortageEntrySchema],
  ["DrugShortagesResponse", DrugShortagesResponseSchema],
  ["ShortagesResponse", ShortagesResponseSchema],
  ["AdverseEventReport", AdverseEventReportSchema],
  ["AdverseEventStats", AdverseEventStatsSchema],
  ["AdverseEventStatsResponse", AdverseEventStatsResponseSchema],
  ["LiteratureReference", LiteratureReferenceSchema],
  ["DrugLiteratureResponse", DrugLiteratureResponseSchema],
  ["TrialEntry", TrialEntrySchema],
  ["DrugTrialsResponse", DrugTrialsResponseSchema],
  ["DrugHistoryResponse", DrugHistoryResponseSchema],
  ["PgxPair", PgxPairSchema],
  ["DrugPgxResponse", DrugPgxResponseSchema],
  ["ReactionSummary", ReactionSummarySchema],
  ["ReactionDrugRow", ReactionDrugRowSchema],
  ["RelatedReaction", RelatedReactionSchema],
  ["MeshTreeNode", MeshTreeNodeSchema],
  ["ReactionMeta", ReactionMetaSchema],
  ["Reaction", ReactionSchema],
  ["ReactionsListResponse", ReactionsListResponseSchema],
  ["ReactionResponse", ReactionResponseSchema],
  ["ConditionSummary", ConditionSummarySchema],
  ["ConditionDrugRow", ConditionDrugRowSchema],
  ["RelatedCondition", RelatedConditionSchema],
  ["Condition", ConditionSchema],
  ["ConditionsListResponse", ConditionsListResponseSchema],
  ["ConditionResponse", ConditionResponseSchema],
  ["PassageSection", PassageSectionSchema],
  ["RetrievalMethod", RetrievalMethodSchema],
  ["SemanticPassage", SemanticPassageSchema],
  ["SemanticSearchResponse", SemanticSearchResponseSchema],
  ["GroundedRequest", GroundedRequestSchema],
  ["GroundedCitation", GroundedCitationSchema],
  ["GroundingSpan", GroundingSpanSchema],
  ["GroundedPassage", GroundedPassageSchema],
  ["GroundedResponse", GroundedResponseSchema],
  ["WebhookEventName", WebhookEventNameSchema],
  ["WebhookDrugChange", WebhookDrugChangeSchema],
  ["WebhookEventPayload", WebhookEventPayloadSchema],
  ["WebhookEndpoint", WebhookEndpointSchema],
  ["WebhookCreateRequest", WebhookCreateRequestSchema],
  ["WebhookEndpointCreated", WebhookEndpointCreatedSchema],
  ["WebhooksListResponse", WebhooksListResponseSchema],
  ["WebhookDeleteResponse", WebhookDeleteResponseSchema],
] as const;
