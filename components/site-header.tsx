      ...
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between gap-2 px-4 sm:px-6">
        ...
        <div className="flex items-center gap-1 text-sm">
          ...
          <a
            ...
            aria-label="GitHub"
            title="GitHub"
            className="ml-1 hidden h-8 w-8 place-items-center rounded-md border border-border/80 bg-background text-muted-foreground transition-colors hover:bg-accent hover:text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring motion-reduce:transition-none lg:grid"
          >
            <svg
              viewBox="0 0 24 24"
              className="h-4 w-4"
          ...
          <div className="ml-1 border-l border-border/60 pl-2 lg:ml-2">
            <ThemeToggle />
          </div>
        </div>
      </div>
